            ...
            <div className="w-11/12 max-w-6xl mx-auto -mt-16 grid grid-cols-1 lg:grid-cols-12 gap-8 relative z-20">
                ...
                <div className="lg:col-span-8 space-y-8">
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-[40px] p-8 md:p-12 shadow-2xl border border-transparent dark:border-slate-800 relative overflow-hidden group">
                        ...
                        <div className="mt-8 pt-8 border-t border-dashed border-slate-100 dark:border-slate-800 flex items-center gap-2 text-blue-600 dark:text-blue-400 font-black text-[10px] uppercase tracking-widest">
                            <BookOpen size={14} /> Peer Reviewed Research Summary
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="bg-white dark:bg-slate-900 rounded-[40px] p-10 shadow-xl border border-transparent dark:border-slate-800 text-center relative group">
                            <div className="absolute top-0 right-0 p-6 text-slate-100 dark:text-slate-800 opacity-10 group-hover:opacity-20 transition-opacity">
                                <TrendingUp size={80} />
                            </div>
                            <div className="flex items-center justify-center gap-2 mb-8 text-slate-400 font-black uppercase text-[10px] tracking-widest">
                                Recovery Metrics
                            </div>
                        ...
                        <div className="bg-white dark:bg-slate-900 rounded-[40px] p-10 shadow-xl border border-transparent dark:border-slate-800 text-center relative group">
                            ...
                            <div className="h-40 flex items-end justify-center gap-6 px-10 pt-4">
                                <div className="w-full bg-slate-100 dark:bg-slate-800 rounded-t-3xl relative h-full overflow-hidden">
                                    <motion.div 
                                        initial={{ height: 0 }}
                                        animate={{ height: `${Math.min(prevalenceValue * 8, 100)}%` }}
                                        transition={{ duration: 2, ease: "circOut" }}
                                        className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-blue-700 to-blue-400 rounded-t-2xl shadow-[0_-10px_20px_rgba(59,130,246,0.3)]"
                                    ></motion.div>
                                </div>
                            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="bg-orange-50/50 dark:bg-orange-900/10 rounded-[40px] p-10 border border-orange-100 dark:border-orange-900/30 group">
                            <div className="w-16 h-16 bg-orange-100 dark:bg-orange-900/30 rounded-2xl flex items-center justify-center text-orange-500 mb-8 group-hover:scale-110 transition-transform">
                                <Salad size={32} />
                            </div>
                        ...
                        <div className="bg-purple-50/50 dark:bg-purple-900/10 rounded-[40px] p-10 border border-purple-100 dark:border-purple-900/30 group">
                            <div className="w-16 h-16 bg-purple-100 dark:bg-purple-900/30 rounded-2xl flex items-center justify-center text-purple-500 mb-8 group-hover:scale-110 transition-transform">
                                <Dumbbell size={32} />
                            </div>
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-[40px] p-8 md:p-12 shadow-xl border border-transparent dark:border-slate-800">
                        <div className="flex items-center gap-4 mb-8">
                            ...
                            <h3 className="text-2xl font-black text-slate-900 dark:text-white uppercase tracking-tight">Clinical Management</h3>
                        </div>
                        <div className="p-8 bg-slate-50 dark:bg-slate-800/50 rounded-[32px] border border-slate-100 dark:border-slate-800 font-bold text-slate-700 dark:text-slate-300 text-lg leading-relaxed shadow-inner">
                            {disease.treatment}
                        </div>
                    </div>
                </div>
                ...
                <div className="lg:col-span-4 space-y-8">
                    ...
                    <div className="bg-gradient-to-br from-indigo-600 to-blue-800 rounded-[40px] p-10 text-white shadow-2xl relative overflow-hidden group">
                        <Bot className="absolute -bottom-6 -right-6 text-white/10 group-hover:scale-110 transition-transform duration-700" size={180} />
                        ...
                        <p className="text-blue-100 text-sm font-medium mb-10 leading-relaxed">
                            Consult CompileXBot for an intelligent comparison of your symptoms against our 500+ condition database.
                        </p>
                        <button onClick={() => setIsCheckerOpen(true)} className="w-full py-5 bg-white text-blue-600 rounded-2xl font-black uppercase text-xs tracking-widest hover:bg-blue-50 active:scale-95 transition-all shadow-2xl">Initiate AI Check</button>
                    </div>
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-[40px] p-10 shadow-xl border border-transparent dark:border-slate-800 text-center">
                        ...
                        <p className="text-slate-500 dark:text-slate-400 text-sm font-medium mb-10 leading-relaxed">
                            Our database recommends a prioritized consultation with a verified <b>{disease.specialist}</b> for this condition.
                        </p>
                    ...
                    <div className="bg-red-50/50 dark:bg-red-900/10 border border-red-100 dark:border-red-900/30 rounded-[40px] p-10">
                        ...
                        <h4 className="text-xl font-black text-red-600 dark:text-red-500 uppercase tracking-tighter mb-4">Critical Precaution</h4>
                                ...
                                {!aiResponse ? (
                                    ...
                                    <div className="space-y-8 animate-fade-up">
                                        <div className="bg-white dark:bg-slate-900 rounded-[32px] p-10 border border-slate-100 dark:border-slate-800 shadow-2xl whitespace-pre-line font-medium text-slate-700 dark:text-slate-300 leading-relaxed border-l-[12px] border-l-blue-600 text-lg">
                                            <div className="flex items-center gap-3 mb-8"><ShieldCheck className="text-green-500" size={32} /><h4 className="font-black text-slate-900 dark:text-white uppercase tracking-tighter text-2xl">Assessment Result</h4></div>
                                            {aiResponse}
                                        </div>
